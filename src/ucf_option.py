...
parser.add_argument('--model-path', default='/root/autodl-tmp/model/ucf/model_ucf.pth')
parser.add_argument('--use-checkpoint', default=False, type=bool)
parser.add_argument('--checkpoint-path', default='/root/autodl-tmp/model/ucf/checkpoint_ucf.pth')
parser.add_argument('--batch-size', default=64, type=int)
parser.add_argument('--visual-train-list', default='/root/autodl-tmp/code/list/ucf_CLIP_rgb.csv')
parser.add_argument('--text-train-list', default='/root/autodl-tmp/code/list/ucf_text.csv')
parser.add_argument('--visual-test-list', default='/root/autodl-tmp/code/list/ucf_CLIP_rgbtest.csv')
parser.add_argument('--text-test-list', default='/root/autodl-tmp/code/list/ucf_text_test.csv')
parser.add_argument('--gt-path', default='/root/autodl-tmp/code/list/gt_ucf.npy')
parser.add_argument('--gt-segment-path', default='/root/autodl-tmp/code/list/gt_segment_ucf.npy')
parser.add_argument('--gt-label-path', default='/root/autodl-tmp/code/list/gt_label_ucf.npy')
