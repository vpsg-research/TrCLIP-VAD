...
feature_list = '/test004/code/VadCLIP-main/list/xd_CLIP_rgbtest.csv'
# the ground truth txt

gt_txt = '/test004/code/VadCLIP-main/list/annotations.txt'     ## the path of test annotations
...
np.save('/test004/code/VadCLIP-main/list/gt_xd.npy', gt)
